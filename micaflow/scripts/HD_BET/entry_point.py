...
from checkpoint_download import maybe_download_parameters
from hd_bet_prediction import get_hdbet_predictor, hdbet_predict
...
def main():
    ...
    parser.add_argument(
        "--verbose", action="store_true", required=False, help="Talk to me."
    )
    ...
    hdbet_predict(
        ...
        args.output,
        predictor,
        keep_brain_mask=args.save_bet_mask,
