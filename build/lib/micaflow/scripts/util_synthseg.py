...
def print_extended_help():
    ...
    help_msg = """
    SynthSeg: Neural Network-Based Brain MRI Segmentation Tool
    =========================================================
    
    USAGE:
      python util_synthseg.py [options]
    ...
    EXAMPLES:
      # Basic segmentation
      python util_synthseg.py --i t1w_scan.nii.gz --o segmentation.nii.gz
      ...
      # With volume calculation
      python util_synthseg.py --i t1w_scan.nii.gz --o segmentation.nii.gz \\
        --vol volumes.csv
    
      # Batch processing (folder)
      python util_synthseg.py --i input_folder/ --o output_folder/
    
      # Using CPU with multiple threads
      python util_synthseg.py --i t1w_scan.nii.gz --o segmentation.nii.gz \\
        --cpu --threads 4
    
    For more information, see: https://github.com/BBillot/SynthSeg
    """
    print(help_msg)
